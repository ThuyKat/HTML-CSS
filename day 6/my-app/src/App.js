...
function App() {
  ...
  return (
    <div className="App">
     ...
     {/* <ProductItem title="First product" price={500} rating={3}/>
     <ProductItem title="Second product" price={500} rating={3}/>
     <ProductItem title="Third product" price={500} rating={3}/>
     <ProductItem title="Fourth product" price={500} rating={3}/> */}
     {
      productData && productData.length>0 ? productData.map(productItem => <ProductItem title={productItem.title} price={productItem.price} img={productItem.images} rating/>) : "no product available"
     }
     </div>
    </div>
  );
